...
public class OrthographicCameraExercise extends ApplicationAdapter {
    ...
    public void resize(int width, int height) {
        ...
        camera.viewportWidth = aspect * camera.viewportHeight;
    }
    ...
    public void render() {
        ...
        float sinX = MathUtils.sin( MathUtils.PI * interval /PERIOD);
        float sinY = MathUtils.sin(MathUtils.PI2 * interval / PERIOD);
        System.out.println("Interval: " + interval + ", sinX: " + sinX + ", sinY: " + sinY);
        float x = X_CENTER + X_AMPLITUDE * sinX;
        float y = Y_CENTER + Y_AMPLITUDE * sinY;
